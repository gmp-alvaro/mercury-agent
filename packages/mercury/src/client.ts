import type { CreateTransactionInput, MercuryAccount, MercuryRecipient, MercuryTransaction } from "@mercury-agent/types"
...
export class MercuryClient {
  ...
  constructor(options: MercuryClientOptions = {}) {
    ...
    this.baseUrl = options.baseUrl ?? process.env.MERCURY_API_BASE_URL ?? "https://backend.mercury.com/api/v1"
  }
  ...
  createTransaction(payload: CreateTransactionInput): Promise<MercuryTransaction> {
